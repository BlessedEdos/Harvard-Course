...
python3 -c " from tests0 import test_prime; test_prime(37, True)"
python3 -c " from tests0 import test_prime; test_prime(41, True)"
python3 -c " from tests0 import test_prime; test_prime(50, False)"
python3 -c " from tests0 import test_prime; test_prime(53, True)"
python3 -c " from tests0 import test_prime; test_prime(57, False)"